...
- (void)sendTimerFired;
- (void)send;
- (BOOL)adTypeNeedMonitor:(id)arg1 inChannel:(id)arg2;
- (void)logSplashVideo:(id)arg1;
- (void)logAdCostWithNetStatus:(id)arg1 source:(id)arg2 time:(int)arg3;
- (void)logAdFillWithChannel:(id)arg1 adType:(id)arg2 request:(int)arg3 response:(int)arg4 hit:(int)arg5;
- (void)logAdFillWithAdChannel:(id)arg1 adType:(id)arg2 response:(int)arg3;
- (void)logAdFillWithAdChannel:(id)arg1 adType:(id)arg2 hit:(int)arg3;
- (void)logAdFillWithAdChannel:(id)arg1 adType:(id)arg2 request:(int)arg3;
- (void)reset;
- (void)dealloc;
- (id)init;
