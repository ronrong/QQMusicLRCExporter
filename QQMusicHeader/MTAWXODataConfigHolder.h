...
@class MTAWXODataConfig, NSMutableDictionary;

@interface MTAWXODataConfigHolder : NSObject
{
    struct dispatch_queue_s *task_queue;
    struct sqlite3 *db;
    MTAWXODataConfig *_sdkCfg;
    MTAWXODataConfig *_appCfg;
...
@property(retain, nonatomic) MTAWXODataConfig *appCfg; // @synthesize appCfg=_appCfg;
@property(retain, nonatomic) MTAWXODataConfig *sdkCfg; // @synthesize sdkCfg=_sdkCfg;
