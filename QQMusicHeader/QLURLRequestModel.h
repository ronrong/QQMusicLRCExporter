...
- (BOOL)qlLoadRequestFromCache:(id)arg1;
- (BOOL)qlloadFromCache:(id)arg1 cacheKey:(id)arg2 expires:(double)arg3 fromDisk:(BOOL)arg4 data:(id *)arg5 error:(id *)arg6 timestamp:(id *)arg7;
