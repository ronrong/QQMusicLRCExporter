...
+ (id)getMTAWXOUDID;
+ (void)trackGameUser:(id)arg1 world:(id)arg2 level:(id)arg3 appkey:(id)arg4 isRealTime:(BOOL)arg5;
+ (void)trackGameUser:(id)arg1 world:(id)arg2 level:(id)arg3;
+ (void)reportAppMonitorStat:(id)arg1 appkey:(id)arg2 isRealTime:(BOOL)arg3;
+ (void)reportAppMonitorStat:(id)arg1;
+ (void)reportAccount:(id)arg1 type:(unsigned int)arg2 ext:(id)arg3 appkey:(id)arg4 isRealTime:(BOOL)arg5;
+ (void)reportAccount:(id)arg1 type:(unsigned int)arg2 ext:(id)arg3;
+ (void)reportQQ:(id)arg1 appkey:(id)arg2 isRealTime:(BOOL)arg3;
+ (void)reportQQ:(id)arg1;
+ (void)stopSession;
+ (void)startNewSession:(BOOL)arg1;
+ (void)startNewSession;
+ (void)trackCustomKeyValueEventEnd:(id)arg1 props:(id)arg2 appkey:(id)arg3 isRealTime:(BOOL)arg4;
...
+ (void)trackCustomKeyValueEvent:(id)arg1 props:(id)arg2 appkey:(id)arg3 isRealTime:(BOOL)arg4;
+ (void)trackCustomKeyValueEvent:(id)arg1 props:(id)arg2;
+ (void)trackCustomEventEnd:(id)arg1 args:(id)arg2 appkey:(id)arg3 isRealTime:(BOOL)arg4;
...
+ (void)trackCustomEvent:(id)arg1 args:(id)arg2 appkey:(id)arg3 isRealTime:(BOOL)arg4;
+ (void)trackCustomEvent:(id)arg1 args:(id)arg2;
+ (void)trackError:(id)arg1 appkey:(id)arg2 isRealTime:(BOOL)arg3;
+ (void)trackError:(id)arg1;
+ (void)trackException:(id)arg1 appkey:(id)arg2 isRealTime:(BOOL)arg3;
+ (void)trackException:(id)arg1;
+ (void)trackPageViewEnd:(id)arg1 appkey:(id)arg2 isRealTime:(BOOL)arg3;
+ (void)trackPageViewEnd:(id)arg1;
+ (void)trackPageViewBegin:(id)arg1 appkey:(id)arg2;
+ (void)trackPageViewBegin:(id)arg1;
+ (void)trackDirectPageViewEnd:(id)arg1 appkey:(id)arg2 isRealTime:(BOOL)arg3;
+ (void)trackDirectPageViewBegin:(id)arg1 appkey:(id)arg2;
+ (void)commitCachedStats:(int)arg1;
+ (BOOL)startWithAppkey:(id)arg1 checkedSdkVersion:(id)arg2;
