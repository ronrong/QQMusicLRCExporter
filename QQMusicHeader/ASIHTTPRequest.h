...
@interface ASIHTTPRequest : NSOperation <NSCopying>
{
    ...
    BOOL _didSeprateRequestByRange;
...
+ (BOOL)isValidPacFile:(id)arg1 pacURL:(id)arg2;
+ (id)pacFileKey:(id)arg1 pacURL:(id)arg2;
+ (BOOL)isValidPacFile:(id)arg1;
+ (BOOL)existFreeConnectionForURL:(id)arg1;
...
@property BOOL didSeprateRequestByRange; // @synthesize didSeprateRequestByRange=_didSeprateRequestByRange;
