...
- (BOOL)isInCache:(id)arg1;
- (void)addImage:(id)arg1 forKey:(id)arg2;
- (id)DefaultImageForName:(id)arg1 cache:(BOOL)arg2;
- (id)FaceImageForName:(id)arg1;
- (id)KeyboardImageForName:(id)arg1 cache:(BOOL)arg2;
- (id)ReserveImageForName:(id)arg1;
- (id)WebViewImageForName:(id)arg1;
- (id)QZoneIconImageForName:(id)arg1 cache:(BOOL)arg2;
- (id)ADIconImageForName:(id)arg1 cache:(BOOL)arg2;
- (id)PlayerIconImageForName:(id)arg1 cache:(BOOL)arg2;
- (id)IconImageForName:(id)arg1 cache:(BOOL)arg2;
- (id)SkinImageForName:(id)arg1 cache:(BOOL)arg2 key:(id)arg3 path:(id)arg4;
- (id)SkinImageForName:(id)arg1 cache:(BOOL)arg2 key:(id)arg3;
- (id)ImageForName:(id)arg1 basePath:(id)arg2 cache:(BOOL)arg3 key:(id)arg4 isReserve:(BOOL)arg5;
...
- (id)SecretFileImageForName:(id)arg1 cache:(BOOL)arg2;
- (void)dealloc;
