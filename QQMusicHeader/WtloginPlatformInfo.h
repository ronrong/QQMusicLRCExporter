...
@class MemSig, NSData, NSMutableArray, NSMutableDictionary, NSString, RemortServerList, SafeSingleItemWrapper;
...
@property(readonly) NSMutableArray *domainList; // @synthesize domainList;
...
- (void)InitDevInfo;
- (id)init;
- (BOOL)decryptWithDeviceKey:(id)arg1 andOutData:(id)arg2;
