...
@class GCDAsyncSocket, HTTPConfig, HTTPMessage, NSMutableArray, NSObject<HTTPResponse>, NSObject<OS_dispatch_queue>, NSString, TADDownloadTask;
...
- (BOOL)tryRedirectToOriginalUrl;
- (BOOL)tryFetchDataFromNetwork;
- (void)die;
- (BOOL)shouldDie;
- (void)finishResponse;
