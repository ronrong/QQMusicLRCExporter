...
@interface WloginSdk : NSObject
{
    ...
    struct dispatch_queue_s *wtlogin_queue;
...
- (int)quickLoginActiveStart:(id)arg1 SelfAppid:(unsigned int)arg2 SelfSubAppid:(unsigned int)arg3 DstAppid:(unsigned int)arg4 DstSubAppid:(unsigned int)arg5 DstSourceApplication:(id)arg6 DstScheme:(id)arg7 andDelegate:(id)arg8 tag:(long *)arg9;
- (int)quickLoginCancelled:(id)arg1 andDelegate:(id)arg2 tag:(long *)arg3;
- (int)quickLoginActiveStart:(id)arg1 sourceApplication:(id)arg2 appid:(unsigned int)arg3 subAppid:(unsigned int)arg4 scheme:(id)arg5 andDelegate:(id)arg6 tag:(long *)arg7;
- (int)quickLoginStart:(id)arg1 userAccount:(id)arg2 sourceApplication:(id)arg3 andDelegate:(id)arg4 tag:(long *)arg5;
- (int)quickLoginResult:(id)arg1 outAction:(int *)arg2 outUin:(unsigned long long *)arg3;
- (BOOL)quickLogin:(unsigned int)arg1 subAppid:(unsigned int)arg2 scheme:(id)arg3;
- (BOOL)quickLogin:(unsigned int)arg1 subAppid:(unsigned int)arg2 scheme:(id)arg3 useApp:(int)arg4;
- (id)readUserListFromPasteboard;
- (BOOL)canQuickLogin:(id)arg1;
...
- (int)checkSmsVerifyLoginCode:(id)arg1 andSmsInputString:(id)arg2 byTag:(long)arg3;
- (int)__checkSmsVerifyLoginCode:(id)arg1 userAccount:(id)arg2 andSmsInputString:(id)arg3;
- (int)refreshSmsVerifyLoginCode:(id)arg1;
- (int)refreshSmsVerifyLoginCode:(id)arg1 byTag:(long)arg2;
...
- (int)checkSmsVerifyLoginAccount:(id)arg1 andAppID:(unsigned int)arg2 tag:(long *)arg3;
- (int)__checkSmsVerifyLoginAccount:(id)arg1 userPhone:(id)arg2 andAppID:(unsigned int)arg3;
- (int)checkSmsCodeAndLogin:(id)arg1 andSmsInputString:(id)arg2;
- (int)checkSmsCodeAndLogin:(id)arg1 andSmsInputString:(id)arg2 byTag:(long)arg3;
- (int)__checkSmsCodeAndLogin:(id)arg1 userAccount:(id)arg2 andSmsInputString:(id)arg3;
- (int)refreshSmsCode:(id)arg1 andSmsAppId:(unsigned int)arg2;
- (int)refreshSmsCode:(id)arg1 andSmsAppId:(unsigned int)arg2 byTag:(long)arg3;
- (int)__refreshSmsCode:(id)arg1 userAccount:(id)arg2 andSmsAppId:(unsigned int)arg3;
- (int)checkPictureAndLogin:(id)arg1 andPicInputString:(id)arg2;
- (int)checkPictureAndLogin:(id)arg1 andPicInputString:(id)arg2 byTag:(long)arg3;
- (int)__checkPictureAndLogin:(id)arg1 userAccount:(id)arg2 andPicInputString:(id)arg3;
- (int)refreshPictureData:(id)arg1;
- (int)refreshPictureData:(id)arg1 byTag:(long)arg2;
- (int)__refreshPictureData:(id)arg1 userAccount:(id)arg2;
- (int)loginBySmsVerifyLogin:(id)arg1 andAppid:(unsigned int)arg2 andPasswd:(id)arg3 andSigBitmap:(unsigned int)arg4 andLoginFlag:(int)arg5 tag:(long)arg6;
...
- (int)loginBySmsVerifyLogin:(id)arg1 andAppid:(unsigned int)arg2 andPasswd:(id)arg3 andSigBitmap:(unsigned int)arg4 andOtherAppidNum:(unsigned int)arg5 andOtherAppidList:(unsigned int *)arg6 andLoginFlag:(int)arg7 tag:(long)arg8;
...
- (int)loginWithPasswd:(id)arg1 andAppid:(unsigned int)arg2 andPasswd:(id)arg3 andSigBitmap:(unsigned int)arg4 andLoginFlag:(int)arg5 tag:(long *)arg6;
...
- (int)loginWithPasswd:(id)arg1 andAppid:(unsigned int)arg2 andPasswd:(id)arg3 andSigBitmap:(unsigned int)arg4 andOtherAppidNum:(unsigned int)arg5 andOtherAppidList:(unsigned int *)arg6 andLoginFlag:(int)arg7 tag:(long *)arg8;
...
- (int)loginByExchangeSig:(id)arg1 byD2:(id)arg2 forAccount:(id)arg3 andAppid:(unsigned int)arg4 andSigBitmap:(unsigned int)arg5 andOtherAppidNum:(unsigned int)arg6 andOtherAppidList:(unsigned int *)arg7 tag:(long *)arg8;
...
- (int)loginByExchangeSig:(id)arg1 forAccount:(id)arg2 andAppid:(unsigned int)arg3 andSigBitmap:(unsigned int)arg4 andOtherAppidNum:(unsigned int)arg5 andOtherAppidList:(unsigned int *)arg6 tag:(long *)arg7;
...
- (int)loginByExchangeSig:(id)arg1 byAppid:(unsigned int)arg2 forAppid:(unsigned int)arg3 andSigBitmap:(unsigned int)arg4 andOtherAppidNum:(unsigned int)arg5 andOtherAppidList:(unsigned int *)arg6 tag:(long *)arg7;
...
- (int)loginByExchangeSig:(id)arg1 byAppid:(unsigned int)arg2 forAppid:(unsigned int)arg3 andSigBitmap:(unsigned int)arg4 tag:(long *)arg5;
...
- (void)clearKsid;
- (id)ksidString;
- (BOOL)resetLoginProcess:(long)arg1;
...
- (void)setSdkDispatchQueue:(struct dispatch_queue_s *)arg1;
- (void)dealloc;
- (id)customDataByTag:(long)arg1;
